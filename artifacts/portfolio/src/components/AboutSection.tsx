...
export function AboutSection() {
  ...
  return (
    ...
    >
      {/* Line grid — left side, fades right */}
      <div
        ...
        style={{
          ...
          maskImage: "linear-gradient(to right, black 0%, black 28%, transparent 52%)",
          WebkitMaskImage: "linear-gradient(to right, black 0%, black 28%, transparent 52%)",
        }}
      />
